...
![Sketch of the CAD](assets/images/Sketch.png)

![Measurements used](assets/images/Mesurments.png)
...
![Condition of the beam](assets/images/Beam_condition.png)
...
![Material](assets/images/Material.png)
...
![Normal strain](assets/images/Normal_strain_contours.png) 
![Maximum principal stress](assets/images/Contour_plot_of_maximum_principal_stress.png)
(Used max stress under clamped boundary line since indicated max is likely artificial)

![Static structure](assets/images/Static_Structural.png)
...
![Displacement](assets/images/Displacement.png)
...
![Strain gauge](assets/images/Strain_gauge.png)
